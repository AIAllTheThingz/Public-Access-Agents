---
id: DISC-TEST-TEST-DATA-ENVIRONMENT-STANDARD
title: Test Data and Environment Standard
version: 0.1.0
status: baseline
---
# Test Data and Environment Standard

## Purpose

This standard defines detailed requirements for one part of the **Testing and Quality Engineering** discipline:

> Use controlled, synthetic, minimal, isolated, reproducible data and environments; protect secrets and personal data.
