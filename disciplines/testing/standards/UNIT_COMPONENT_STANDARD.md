---
id: DISC-TEST-UNIT-COMPONENT-STANDARD
title: Unit and Component Testing Standard
version: 0.1.0
status: baseline
---
# Unit and Component Testing Standard

## Purpose

This standard defines detailed requirements for one part of the **Testing and Quality Engineering** discipline:

> Test cohesive behavior, boundaries, errors, state transitions, and invariants with deterministic isolated tests.
