---
id: DISC-TEST-DEFECT-REGRESSION-STANDARD
title: Defect and Regression Standard
version: 0.1.0
status: baseline
---
# Defect and Regression Standard

## Purpose

This standard defines detailed requirements for one part of the **Testing and Quality Engineering** discipline:

> Capture fail-before and pass-after evidence, add durable regression coverage, and avoid weakening assertions or skipping tests.
