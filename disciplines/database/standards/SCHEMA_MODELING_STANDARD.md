---
id: DISC-DB-SCHEMA-MODELING-STANDARD
title: Schema and Modeling Standard
version: 0.1.0
status: baseline
---
# Schema and Modeling Standard

## Purpose

This standard defines detailed requirements for one part of the **Database Engineering** discipline:

> Define keys, constraints, relationships, types, nullability, ownership, lifecycle, and domain invariants at the appropriate layer.
