---
id: DISC-DB-SECURITY-ACCESS-STANDARD
title: Database Security and Access Standard
version: 0.1.0
status: baseline
---
# Database Security and Access Standard

## Purpose

This standard defines detailed requirements for one part of the **Database Engineering** discipline:

> Separate administrative and application identities, apply least privilege, protect credentials, encrypt appropriately, and audit privileged access.
