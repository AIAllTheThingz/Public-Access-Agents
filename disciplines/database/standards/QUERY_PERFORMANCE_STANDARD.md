---
id: DISC-DB-QUERY-PERFORMANCE-STANDARD
title: Query and Performance Standard
version: 0.1.0
status: baseline
---
# Query and Performance Standard

## Purpose

This standard defines detailed requirements for one part of the **Database Engineering** discipline:

> Use parameterized queries, bounded result sets, reviewed plans, appropriate indexes, and evidence for material query changes.
