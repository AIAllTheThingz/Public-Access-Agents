---
id: DISC-MAN-DB
title: Database Engineering Package Manifest
version: 0.1.0
status: baseline
---
# Database Engineering Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/SCHEMA_MODELING_STANDARD.md`
- `standards/MIGRATION_STANDARD.md`
- `standards/QUERY_PERFORMANCE_STANDARD.md`
- `standards/TRANSACTION_INTEGRITY_STANDARD.md`
- `standards/SECURITY_ACCESS_STANDARD.md`
- `standards/BACKUP_RECOVERY_STANDARD.md`
