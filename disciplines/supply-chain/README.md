---
id: DISC-PKG-SUPPLY
title: Software Supply Chain Discipline Package
version: 0.1.0
status: baseline
---
# Software Supply Chain Discipline Package

## Purpose

This package provides project-agnostic, language-neutral standards for **Software Supply Chain** work.

It exists to control dependency, build, provenance, vulnerability, licensing, and release-integrity risk. The package converts broad expectations into explicit agent instructions, review questions, required evidence, and completion gates.
...
├── MANIFEST.md
├── standards/
│   ├── DEPENDENCY_INVENTORY_STANDARD.md
│   ├── DEPENDENCY_REVIEW_STANDARD.md
│   ├── LOCKFILE_REPRODUCIBILITY_STANDARD.md
│   ├── SBOM_PROVENANCE_STANDARD.md
│   ├── BUILD_ENVIRONMENT_STANDARD.md
│   ├── VULNERABILITY_LICENSE_STANDARD.md
│   ├── RELEASE_ATTESTATION_STANDARD.md
...
| Standard | Purpose |
|---|---|
| [`Dependency Inventory Standard`](standards/DEPENDENCY_INVENTORY_STANDARD.md) | Maintain direct, transitive, build, runtime, container, plugin, and generated-component visibility. |
| [`Dependency Review Standard`](standards/DEPENDENCY_REVIEW_STANDARD.md) | Evaluate necessity, source, maintainers, update cadence, vulnerabilities, license, permissions, transitive impact, and alternatives. |
| [`Lockfile and Reproducibility Standard`](standards/LOCKFILE_REPRODUCIBILITY_STANDARD.md) | Use deterministic resolution, reviewed lockfiles, controlled registries, checksums, pinned toolchains, and repeatable builds. |
| [`SBOM and Provenance Standard`](standards/SBOM_PROVENANCE_STANDARD.md) | Generate and retain component inventories, source and build metadata, artifact identity, checksums, and provenance appropriate to risk. |
| [`Build Environment Security Standard`](standards/BUILD_ENVIRONMENT_STANDARD.md) | Separate trusted release builds from untrusted contributions, minimize credentials, harden runners, and prevent artifact substitution. |
| [`Vulnerability and License Standard`](standards/VULNERABILITY_LICENSE_STANDARD.md) | Define scanning, triage, remediation, exceptions, disclosure, license review, and update ownership. |
| [`Release Attestation Standard`](standards/RELEASE_ATTESTATION_STANDARD.md) | Sign or attest releases where warranted, verify before promotion or consumption, and retain traceability to reviewed source. |
| [`Supply Chain Completion Evidence`](standards/COMPLETION_EVIDENCE.md) | Record inventories, dependency decisions, lockfile changes, scans, licenses, provenance, build controls, exceptions, and residual risks. |
...
- adding dependencies without necessity review
- trusting package names or popularity
- using mutable build inputs
- scanning only direct dependencies
- publishing artifacts without source traceability
...
Adopting this package does not prove that software supply chain work is complete. Completion requires implementation, verification, evidence, accountable review, and explicit disclosure of remaining limitations.
