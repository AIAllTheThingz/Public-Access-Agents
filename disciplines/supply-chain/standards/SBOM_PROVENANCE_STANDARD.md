---
id: DISC-SUPPLY-SBOM-PROVENANCE-STANDARD
title: SBOM and Provenance Standard
version: 0.1.0
status: baseline
---
# SBOM and Provenance Standard

## Purpose

This standard defines detailed requirements for one part of the **Software Supply Chain** discipline:

> Generate and retain component inventories, source and build metadata, artifact identity, checksums, and provenance appropriate to risk.
