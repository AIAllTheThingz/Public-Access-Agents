---
id: DISC-SUPPLY-LOCKFILE-REPRODUCIBILITY-STANDARD
title: Lockfile and Reproducibility Standard
version: 0.1.0
status: baseline
---
# Lockfile and Reproducibility Standard

## Purpose

This standard defines detailed requirements for one part of the **Software Supply Chain** discipline:

> Use deterministic resolution, reviewed lockfiles, controlled registries, checksums, pinned toolchains, and repeatable builds.
