---
id: DISC-SUPPLY-RELEASE-ATTESTATION-STANDARD
title: Release Attestation Standard
version: 0.1.0
status: baseline
---
# Release Attestation Standard

## Purpose

This standard defines detailed requirements for one part of the **Software Supply Chain** discipline:

> Sign or attest releases where warranted, verify before promotion or consumption, and retain traceability to reviewed source.
