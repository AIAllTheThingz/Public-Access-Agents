---
id: DISC-SUPPLY-DEPENDENCY-INVENTORY-STANDARD
title: Dependency Inventory Standard
version: 0.1.0
status: baseline
---
# Dependency Inventory Standard

## Purpose

This standard defines detailed requirements for one part of the **Software Supply Chain** discipline:

> Maintain direct, transitive, build, runtime, container, plugin, and generated-component visibility.
