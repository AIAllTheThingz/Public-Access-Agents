---
id: DISC-SUPPLY-COMPLETION-EVIDENCE
title: Supply Chain Completion Evidence
version: 0.1.0
status: baseline
---
# Supply Chain Completion Evidence

## Purpose

This standard defines detailed requirements for one part of the **Software Supply Chain** discipline:

> Record inventories, dependency decisions, lockfile changes, scans, licenses, provenance, build controls, exceptions, and residual risks.
