---
id: DISC-MAN-INT
title: Integration Engineering Package Manifest
version: 0.1.0
status: baseline
---
# Integration Engineering Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/CONTRACT_OWNERSHIP_STANDARD.md`
- `standards/RESILIENCE_DELIVERY_STANDARD.md`
- `standards/DATA_MAPPING_VALIDATION_STANDARD.md`
- `standards/SECURITY_STANDARD.md`
- `standards/TESTING_STANDARD.md`
- `standards/CHANGE_MIGRATION_STANDARD.md`
- `standards/OPERATIONS_STANDARD.md`
