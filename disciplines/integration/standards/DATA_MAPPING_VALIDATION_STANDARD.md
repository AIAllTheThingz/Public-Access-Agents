---
id: DISC-INT-DATA-MAPPING-VALIDATION-STANDARD
title: Data Mapping and Validation Standard
version: 0.1.0
status: baseline
---
# Data Mapping and Validation Standard

## Purpose

This standard defines detailed requirements for one part of the **Integration Engineering** discipline:

> Validate source and destination semantics, field mapping, units, formats, null behavior, classification, minimization, and reconciliation.
