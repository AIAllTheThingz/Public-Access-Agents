---
id: DISC-INT-CONTRACT-OWNERSHIP-STANDARD
title: Integration Contract and Ownership Standard
version: 0.1.0
status: baseline
---
# Integration Contract and Ownership Standard

## Purpose

This standard defines detailed requirements for one part of the **Integration Engineering** discipline:

> Define producer, consumer, owners, schema, transport, authentication, authorization, SLAs, support paths, and compatibility.
