---
id: DISC-INT-CHANGE-MIGRATION-STANDARD
title: Integration Change and Migration Standard
version: 0.1.0
status: baseline
---
# Integration Change and Migration Standard

## Purpose

This standard defines detailed requirements for one part of the **Integration Engineering** discipline:

> Plan version coexistence, sequencing, backfill, cutover, rollback, consumer readiness, and retirement.
