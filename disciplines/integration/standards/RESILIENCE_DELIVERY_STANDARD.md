---
id: DISC-INT-RESILIENCE-DELIVERY-STANDARD
title: Resilience and Delivery Standard
version: 0.1.0
status: baseline
---
# Resilience and Delivery Standard

## Purpose

This standard defines detailed requirements for one part of the **Integration Engineering** discipline:

> Define timeouts, retries, backoff, idempotency, ordering, duplicate handling, dead letters, partial failure, and outage behavior.
