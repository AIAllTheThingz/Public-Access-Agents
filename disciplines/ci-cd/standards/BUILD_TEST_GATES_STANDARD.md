---
id: DISC-CICD-BUILD-TEST-GATES-STANDARD
title: Build and Test Gates Standard
version: 0.1.0
status: baseline
---
# Build and Test Gates Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Require risk-proportionate formatting, build, tests, security checks, approvals, and evidence before promotion.
