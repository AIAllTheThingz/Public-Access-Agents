---
id: DISC-CICD-DEPENDENCY-PINNING-STANDARD
title: CI/CD Dependency Pinning Standard
version: 0.1.0
status: baseline
---
# CI/CD Dependency Pinning Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Pin actions, images, tools, and reusable workflows to reviewed versions or immutable references with controlled updates.
