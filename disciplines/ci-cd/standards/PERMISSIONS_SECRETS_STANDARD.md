---
id: DISC-CICD-PERMISSIONS-SECRETS-STANDARD
title: Permissions and Secrets Standard
version: 0.1.0
status: baseline
---
# Permissions and Secrets Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Use minimum token, environment, runner, cloud, and repository permissions; protect secrets from untrusted code and logs.
