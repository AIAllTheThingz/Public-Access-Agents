---
id: DISC-CICD-ROLLBACK-RECOVERY-STANDARD
title: Pipeline Rollback and Recovery Standard
version: 0.1.0
status: baseline
---
# Pipeline Rollback and Recovery Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Define rollback or roll-forward, failed-deployment containment, partial-success handling, cleanup, audit evidence, and operator intervention.
