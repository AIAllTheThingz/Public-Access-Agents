---
id: DISC-CICD-ARTIFACT-PROVENANCE-STANDARD
title: Artifact and Provenance Standard
version: 0.1.0
status: baseline
---
# Artifact and Provenance Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Create immutable, identifiable artifacts with checksums, metadata, SBOM or provenance where applicable, retention, and traceability.
