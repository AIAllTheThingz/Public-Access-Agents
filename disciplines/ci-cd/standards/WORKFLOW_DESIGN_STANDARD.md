---
id: DISC-CICD-WORKFLOW-DESIGN-STANDARD
...
> Define triggers, trust boundaries, concurrency, cancellation, retries, timeouts, reusable workflow contracts, and failure behavior.
