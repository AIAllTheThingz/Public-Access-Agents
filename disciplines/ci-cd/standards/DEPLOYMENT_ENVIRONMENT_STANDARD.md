---
id: DISC-CICD-DEPLOYMENT-ENVIRONMENT-STANDARD
title: Deployment and Environment Standard
version: 0.1.0
status: baseline
---
# Deployment and Environment Standard

## Purpose

This standard defines detailed requirements for one part of the **CI/CD** discipline:

> Separate environments, protect approvals, prevent untrusted promotion, use environment-specific configuration, and verify deployment state.
