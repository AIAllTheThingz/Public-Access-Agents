---
id: DISC-ACC-CONTENT-FORMS-ERRORS-STANDARD
title: Content, Forms, and Errors Standard
version: 0.1.0
status: baseline
---
# Content, Forms, and Errors Standard

## Purpose

This standard defines detailed requirements for one part of the **Accessibility** discipline:

> Provide clear labels, instructions, validation, status messages, alternatives, readable language, and recoverable errors.
