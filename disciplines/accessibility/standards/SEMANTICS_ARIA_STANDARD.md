---
id: DISC-ACC-SEMANTICS-ARIA-STANDARD
title: Semantics and ARIA Standard
version: 0.1.0
status: baseline
---
# Semantics and ARIA Standard

## Purpose

This standard defines detailed requirements for one part of the **Accessibility** discipline:

> Prefer native semantics, use ARIA only when necessary, preserve names, roles, states, relationships, and reading order.
