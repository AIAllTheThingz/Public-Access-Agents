---
id: DISC-ACC-KEYBOARD-FOCUS-STANDARD
title: Keyboard and Focus Standard
version: 0.1.0
status: baseline
---
# Keyboard and Focus Standard

## Purpose

This standard defines detailed requirements for one part of the **Accessibility** discipline:

> Make all interaction keyboard operable with logical order, visible focus, predictable movement, and managed focus for dynamic interfaces.
