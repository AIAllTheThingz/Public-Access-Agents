---
id: DISC-ACC-VISUAL-MOTION-MEDIA-STANDARD
title: Visual, Motion, and Media Standard
version: 0.1.0
status: baseline
---
# Visual, Motion, and Media Standard

## Purpose

This standard defines detailed requirements for one part of the **Accessibility** discipline:

> Address contrast, reflow, zoom, color independence, reduced motion, flashing, captions, transcripts, and audio descriptions as applicable.
