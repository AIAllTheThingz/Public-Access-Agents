---
id: DISC-ACC-WCAG-CONFORMANCE-STANDARD
title: WCAG Conformance Standard
version: 0.1.0
status: baseline
---
...
> Target the repository's declared accessibility level, normally WCAG 2.2 AA for web interfaces, and map applicable success criteria to evidence.
