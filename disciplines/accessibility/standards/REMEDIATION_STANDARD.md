---
id: DISC-ACC-REMEDIATION-STANDARD
title: Accessibility Remediation Standard
version: 0.1.0
status: baseline
---
# Accessibility Remediation Standard

## Purpose

This standard defines detailed requirements for one part of the **Accessibility** discipline:

> Prioritize blockers, record user impact, avoid regressions, provide workarounds where appropriate, and verify fixes manually.
