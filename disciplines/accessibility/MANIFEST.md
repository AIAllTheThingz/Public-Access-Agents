---
id: DISC-MAN-ACC
title: Accessibility Package Manifest
version: 0.1.0
status: baseline
---
...
- `README.md`
- `MANIFEST.md`
- `standards/WCAG_CONFORMANCE_STANDARD.md`
- `standards/SEMANTICS_ARIA_STANDARD.md`
- `standards/KEYBOARD_FOCUS_STANDARD.md`
- `standards/CONTENT_FORMS_ERRORS_STANDARD.md`
- `standards/VISUAL_MOTION_MEDIA_STANDARD.md`
- `standards/TESTING_STANDARD.md`
- `standards/REMEDIATION_STANDARD.md`
