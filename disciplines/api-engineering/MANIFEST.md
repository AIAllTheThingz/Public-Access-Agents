---
id: DISC-MAN-API
title: API Engineering Package Manifest
version: 0.1.0
status: baseline
---
# API Engineering Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/CONTRACT_STANDARD.md`
- `standards/AUTH_SECURITY_STANDARD.md`
- `standards/VERSION_COMPATIBILITY_STANDARD.md`
- `standards/ERROR_IDEMPOTENCY_STANDARD.md`
- `standards/PAGINATION_LIMITS_STANDARD.md`
