---
id: DISC-API-PAGINATION-LIMITS-STANDARD
title: Pagination and Limits Standard
version: 0.1.0
status: baseline
---
# Pagination and Limits Standard

## Purpose

This standard defines detailed requirements for one part of the **API Engineering** discipline:

> Define bounded page sizes, ordering, cursors, quotas, rate limits, payload limits, timeout behavior, and resource-exhaustion controls.
