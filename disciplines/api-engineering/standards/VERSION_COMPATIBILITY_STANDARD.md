---
id: DISC-API-VERSION-COMPATIBILITY-STANDARD
title: API Versioning and Compatibility Standard
version: 0.1.0
status: baseline
---
# API Versioning and Compatibility Standard

## Purpose

This standard defines detailed requirements for one part of the **API Engineering** discipline:

> Define compatibility promises, additive change rules, deprecation, sunset, migration, and breaking-change approval.
