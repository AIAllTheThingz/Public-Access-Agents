---
id: DISC-API-OBSERVABILITY-STANDARD
title: API Observability Standard
version: 0.1.0
status: baseline
---
...
> Measure availability, latency, errors, saturation, auth failures, and usage without logging secrets or sensitive payloads.
