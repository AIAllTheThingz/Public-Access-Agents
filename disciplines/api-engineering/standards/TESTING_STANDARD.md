---
id: DISC-API-TESTING-STANDARD
title: API Testing Standard
version: 0.1.0
status: baseline
---
...
> Validate contracts, examples, authorization, validation, pagination, retries, idempotency, compatibility, and dependency failures.
