---
id: DISC-API-ERROR-IDEMPOTENCY-STANDARD
title: Error and Idempotency Standard
version: 0.1.0
status: baseline
---
# Error and Idempotency Standard

## Purpose

This standard defines detailed requirements for one part of the **API Engineering** discipline:

> Use stable machine-readable errors, correlation identifiers, retry guidance, idempotency keys where needed, and explicit duplicate behavior.
