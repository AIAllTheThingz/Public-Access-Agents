---
id: DISC-API-AUTH-SECURITY-STANDARD
title: API Authentication and Security Standard
version: 0.1.0
status: baseline
---
# API Authentication and Security Standard

## Purpose

This standard defines detailed requirements for one part of the **API Engineering** discipline:

> Enforce identity and object-level authorization server-side, validate trust-boundary data, constrain resources, and prevent sensitive-data leakage.
