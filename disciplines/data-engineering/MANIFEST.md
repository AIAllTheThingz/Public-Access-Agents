---
id: DISC-MAN-DATA
title: Data Engineering Package Manifest
version: 0.1.0
status: baseline
---
# Data Engineering Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/DATA_CONTRACT_STANDARD.md`
- `standards/LINEAGE_METADATA_STANDARD.md`
- `standards/QUALITY_STANDARD.md`
- `standards/PIPELINE_RELIABILITY_STANDARD.md`
- `standards/PRIVACY_GOVERNANCE_STANDARD.md`
- `standards/REPLAY_BACKFILL_STANDARD.md`
