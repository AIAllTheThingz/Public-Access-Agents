---
id: DISC-DATA-LINEAGE-METADATA-STANDARD
title: Lineage and Metadata Standard
version: 0.1.0
status: baseline
---
# Lineage and Metadata Standard

## Purpose

This standard defines detailed requirements for one part of the **Data Engineering** discipline:

> Record sources, transformations, destinations, ownership, classifications, schedules, versions, and retention.
