---
id: DISC-APPSEC-SECRETS-CRYPTOGRAPHY-STANDARD
title: Secrets and Cryptography Standard
version: 0.1.0
status: baseline
---
# Secrets and Cryptography Standard

## Purpose

This standard defines detailed requirements for one part of the **Application Security** discipline:

> Keep secrets out of source and telemetry, use approved secret stores, avoid custom cryptography, define rotation and failure behavior, and document trust anchors.
