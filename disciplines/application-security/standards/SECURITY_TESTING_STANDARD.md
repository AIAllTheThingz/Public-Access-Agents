---
id: DISC-APPSEC-SECURITY-TESTING-STANDARD
...
> Require negative authorization, boundary, abuse, injection, parser, configuration, and dependency-security tests proportionate to risk.
