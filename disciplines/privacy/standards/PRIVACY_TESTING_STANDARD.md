---
id: DISC-PRIV-PRIVACY-TESTING-STANDARD
title: Privacy Testing Standard
version: 0.1.0
status: baseline
---
# Privacy Testing Standard

## Purpose

This standard defines detailed requirements for one part of the **Privacy and Data Governance** discipline:

> Test data flows, minimization, access, rights, retention, deletion, exports, logs, and failure behavior with synthetic data.
