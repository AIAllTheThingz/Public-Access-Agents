---
id: DISC-PRIV-LOGGING-ANALYTICS-STANDARD
title: Logging and Analytics Privacy Standard
version: 0.1.0
status: baseline
---
# Logging and Analytics Privacy Standard

## Purpose

This standard defines detailed requirements for one part of the **Privacy and Data Governance** discipline:

> Exclude or redact sensitive data, minimize identifiers, constrain analytics, and review support and debugging artifacts.
