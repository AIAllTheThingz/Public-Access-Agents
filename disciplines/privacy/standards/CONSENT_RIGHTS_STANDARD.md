---
id: DISC-PRIV-CONSENT-RIGHTS-STANDARD
title: Consent and Data Rights Standard
version: 0.1.0
status: baseline
---
# Consent and Data Rights Standard

## Purpose

This standard defines detailed requirements for one part of the **Privacy and Data Governance** discipline:

> Define notices, choices, consent where applicable, access, correction, export, deletion, objection, and verification behavior.
