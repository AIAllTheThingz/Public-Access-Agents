---
id: DISC-PRIV-MINIMIZATION-PURPOSE-STANDARD
title: Purpose and Minimization Standard
version: 0.1.0
status: baseline
---
# Purpose and Minimization Standard

## Purpose

This standard defines detailed requirements for one part of the **Privacy and Data Governance** discipline:

> Collect, process, expose, and retain only data necessary for an approved purpose; prevent secondary use without review.
