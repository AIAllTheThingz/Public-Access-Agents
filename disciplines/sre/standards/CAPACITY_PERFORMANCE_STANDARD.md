---
id: DISC-SRE-CAPACITY-PERFORMANCE-STANDARD
title: Capacity and Performance Standard
version: 0.1.0
status: baseline
---
# Capacity and Performance Standard

## Purpose

This standard defines detailed requirements for one part of the **Site Reliability Engineering** discipline:

> Assess demand, saturation, quotas, bottlenecks, scaling, cost, and headroom using representative evidence.
