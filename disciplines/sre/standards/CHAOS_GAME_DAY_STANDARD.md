---
id: DISC-SRE-CHAOS-GAME-DAY-STANDARD
title: Game Day and Learning Standard
version: 0.1.0
status: baseline
---
# Game Day and Learning Standard

## Purpose

This standard defines detailed requirements for one part of the **Site Reliability Engineering** discipline:

> Exercise credible failure and recovery scenarios safely, record observations, and feed findings into design and tests.
