---
id: DISC-SRE-SLO-ERROR-BUDGET-STANDARD
title: SLO and Error Budget Standard
version: 0.1.0
status: baseline
---
# SLO and Error Budget Standard

## Purpose

This standard defines detailed requirements for one part of the **Site Reliability Engineering** discipline:

> Define service indicators, objectives, measurement windows, exclusions, ownership, and decision use for reliability risk.
