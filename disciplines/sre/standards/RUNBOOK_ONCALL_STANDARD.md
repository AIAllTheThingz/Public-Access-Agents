---
id: DISC-SRE-RUNBOOK-ONCALL-STANDARD
title: Runbook and On-Call Standard
version: 0.1.0
status: baseline
---
# Runbook and On-Call Standard

## Purpose

This standard defines detailed requirements for one part of the **Site Reliability Engineering** discipline:

> Provide actionable diagnostics, safe procedures, escalation, access requirements, rollback, and ownership.
