---
id: DISC-ARCH-BOUNDARIES-DEPENDENCIES-STANDARD
title: Boundaries and Dependencies Standard
version: 0.1.0
status: baseline
---
# Boundaries and Dependencies Standard

## Purpose

This standard defines detailed requirements for one part of the **Architecture and System Design** discipline:

> Assign cohesive responsibilities, explicit interfaces, dependency direction, failure ownership, and allowed coupling. Avoid hidden shared state and circular dependencies.
