---
id: DISC-ARCH-SYSTEM-CONTEXT-STANDARD
title: System Context Standard
version: 0.1.0
status: baseline
---
# System Context Standard

## Purpose

This standard defines detailed requirements for one part of the **Architecture and System Design** discipline:

> Document users, systems, external dependencies, data flows, ownership, trust boundaries, deployment context, and operational responsibility.
