---
id: DISC-MAN-OBS
title: Observability Package Manifest
version: 0.1.0
status: baseline
---
# Observability Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/TELEMETRY_DESIGN_STANDARD.md`
- `standards/LOGGING_STANDARD.md`
- `standards/METRICS_STANDARD.md`
- `standards/TRACING_STANDARD.md`
- `standards/HEALTH_CHECK_STANDARD.md`
- `standards/ALERTING_RUNBOOK_STANDARD.md`
- `standards/COST_CARDINALITY_STANDARD.md`
