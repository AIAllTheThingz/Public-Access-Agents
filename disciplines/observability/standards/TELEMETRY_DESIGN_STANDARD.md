---
id: DISC-OBS-TELEMETRY-DESIGN-STANDARD
title: Telemetry Design Standard
version: 0.1.0
status: baseline
---
# Telemetry Design Standard

## Purpose

This standard defines detailed requirements for one part of the **Observability** discipline:

> Map user journeys, operations, dependencies, failure modes, and service objectives to logs, metrics, traces, and events.
