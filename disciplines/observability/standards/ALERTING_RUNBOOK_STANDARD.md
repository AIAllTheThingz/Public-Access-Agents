---
id: DISC-OBS-ALERTING-RUNBOOK-STANDARD
title: Alerting and Runbook Standard
version: 0.1.0
status: baseline
---
# Alerting and Runbook Standard

## Purpose

This standard defines detailed requirements for one part of the **Observability** discipline:

> Alert on actionable symptoms with severity, ownership, routing, context, suppression, escalation, and runbook links.
