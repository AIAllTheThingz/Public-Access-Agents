---
id: DISC-OBS-COST-CARDINALITY-STANDARD
title: Telemetry Cost and Cardinality Standard
version: 0.1.0
status: baseline
---
# Telemetry Cost and Cardinality Standard

## Purpose

This standard defines detailed requirements for one part of the **Observability** discipline:

> Control retention, sampling, payload size, tag values, high-cardinality fields, ingestion budgets, and debug escalation.
