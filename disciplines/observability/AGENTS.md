...
This file defines mandatory agent behavior for work governed by the **Observability** discipline.

Its objective is to produce actionable telemetry for diagnosis and operations without creating uncontrolled cost or sensitive-data exposure.
...
- [`standards/TELEMETRY_DESIGN_STANDARD.md`](standards/TELEMETRY_DESIGN_STANDARD.md)
- [`standards/LOGGING_STANDARD.md`](standards/LOGGING_STANDARD.md)
- [`standards/METRICS_STANDARD.md`](standards/METRICS_STANDARD.md)
- [`standards/TRACING_STANDARD.md`](standards/TRACING_STANDARD.md)
- [`standards/HEALTH_CHECK_STANDARD.md`](standards/HEALTH_CHECK_STANDARD.md)
- [`standards/ALERTING_RUNBOOK_STANDARD.md`](standards/ALERTING_RUNBOOK_STANDARD.md)
- [`standards/COST_CARDINALITY_STANDARD.md`](standards/COST_CARDINALITY_STANDARD.md)
