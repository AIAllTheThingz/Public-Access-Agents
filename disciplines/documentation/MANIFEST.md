---
id: DISC-MAN-DOC
title: Documentation Package Manifest
version: 0.1.0
status: baseline
---
...
- `standards/CODE_API_DOCUMENTATION_STANDARD.md`
- `standards/OPERATIONS_RUNBOOK_STANDARD.md`
- `standards/USER_GUIDE_STANDARD.md`
- `standards/DECISION_RECORD_STANDARD.md`
- `standards/EXAMPLE_STANDARD.md`
- `standards/REVIEW_MAINTENANCE_STANDARD.md`
