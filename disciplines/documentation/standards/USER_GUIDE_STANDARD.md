---
id: DISC-DOC-USER-GUIDE-STANDARD
title: User and Administrator Guide Standard
version: 0.1.0
status: baseline
---
# User and Administrator Guide Standard

## Purpose

This standard defines detailed requirements for one part of the **Documentation** discipline:

> Use task-oriented steps, prerequisites, expected outcomes, safe examples, troubleshooting, accessibility, and version context.
