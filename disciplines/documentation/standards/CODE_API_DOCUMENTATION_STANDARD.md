---
id: DISC-DOC-CODE-API-DOCUMENTATION-STANDARD
title: Code and API Documentation Standard
version: 0.1.0
status: baseline
---
# Code and API Documentation Standard

## Purpose

This standard defines detailed requirements for one part of the **Documentation** discipline:

> Document public contracts, behavior, errors, side effects, security expectations, examples, compatibility, and deprecation.
