---
id: DISC-DOC-REVIEW-MAINTENANCE-STANDARD
title: Documentation Review and Maintenance Standard
version: 0.1.0
status: baseline
---
# Documentation Review and Maintenance Standard

## Purpose

This standard defines detailed requirements for one part of the **Documentation** discipline:

> Update documentation with behavior, assign owners, review stale material, validate links and examples, and retire obsolete guidance.
