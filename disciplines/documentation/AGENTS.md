...
This file defines mandatory agent behavior for work governed by the **Documentation** discipline.

Its objective is to treat documentation as part of the deliverable and keep it accurate, discoverable, testable, and usable by non-authors.
...
- [`standards/INFORMATION_ARCHITECTURE_STANDARD.md`](standards/INFORMATION_ARCHITECTURE_STANDARD.md)
- [`standards/CODE_API_DOCUMENTATION_STANDARD.md`](standards/CODE_API_DOCUMENTATION_STANDARD.md)
- [`standards/OPERATIONS_RUNBOOK_STANDARD.md`](standards/OPERATIONS_RUNBOOK_STANDARD.md)
- [`standards/USER_GUIDE_STANDARD.md`](standards/USER_GUIDE_STANDARD.md)
- [`standards/DECISION_RECORD_STANDARD.md`](standards/DECISION_RECORD_STANDARD.md)
- [`standards/EXAMPLE_STANDARD.md`](standards/EXAMPLE_STANDARD.md)
- [`standards/REVIEW_MAINTENANCE_STANDARD.md`](standards/REVIEW_MAINTENANCE_STANDARD.md)
