---
id: DISC-REL-ROLLBACK-ROLLFORWARD-STANDARD
title: Rollback and Roll-Forward Standard
version: 0.1.0
status: baseline
---
# Rollback and Roll-Forward Standard

## Purpose

This standard defines detailed requirements for one part of the **Release Engineering** discipline:

> Define rollback feasibility, data and schema constraints, roll-forward paths, restoration, verification, and decision ownership.
