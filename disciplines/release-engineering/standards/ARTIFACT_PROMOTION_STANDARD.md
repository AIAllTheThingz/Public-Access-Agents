---
id: DISC-REL-ARTIFACT-PROMOTION-STANDARD
title: Artifact Promotion Standard
version: 0.1.0
status: baseline
---
# Artifact Promotion Standard

## Purpose

This standard defines detailed requirements for one part of the **Release Engineering** discipline:

> Promote immutable verified artifacts across environments; do not rebuild release content per environment.
