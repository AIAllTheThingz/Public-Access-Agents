---
id: DISC-REL-SIGNING-ATTESTATION-STANDARD
title: Signing and Attestation Standard
version: 0.1.0
status: baseline
---
# Signing and Attestation Standard

## Purpose

This standard defines detailed requirements for one part of the **Release Engineering** discipline:

> Sign or attest artifacts where risk warrants, protect signing identities, verify signatures, and retain provenance.
