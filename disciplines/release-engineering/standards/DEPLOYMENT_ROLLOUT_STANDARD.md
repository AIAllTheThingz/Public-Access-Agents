---
id: DISC-REL-DEPLOYMENT-ROLLOUT-STANDARD
title: Deployment and Rollout Standard
version: 0.1.0
status: baseline
---
# Deployment and Rollout Standard

## Purpose

This standard defines detailed requirements for one part of the **Release Engineering** discipline:

> Use staged or progressive rollout where appropriate, define health gates, pause criteria, observability, and approval.
