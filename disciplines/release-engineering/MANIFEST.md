---
id: DISC-MAN-REL
title: Release Engineering Package Manifest
version: 0.1.0
status: baseline
---
# Release Engineering Package Manifest
...
- `README.md`
- `MANIFEST.md`
- `standards/VERSIONING_COMPATIBILITY_STANDARD.md`
- `standards/RELEASE_PLANNING_STANDARD.md`
- `standards/ARTIFACT_PROMOTION_STANDARD.md`
- `standards/RELEASE_NOTES_STANDARD.md`
- `standards/DEPLOYMENT_ROLLOUT_STANDARD.md`
- `standards/ROLLBACK_ROLLFORWARD_STANDARD.md`
- `standards/SIGNING_ATTESTATION_STANDARD.md`
