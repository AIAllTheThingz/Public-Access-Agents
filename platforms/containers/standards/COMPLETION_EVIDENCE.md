---
id: CONT-STD-009
title: Container Completion Evidence
version: 0.2.0
status: baseline
---
# Container Completion Evidence

## Purpose

Record image source, digest, build inputs, runtime identity, scan results, health behavior, resource expectations, validation, and limitations.
...
**Requirement:** Record image source, digest, build inputs, runtime identity, scan results, health behavior, resource expectations, validation, and limitations.
