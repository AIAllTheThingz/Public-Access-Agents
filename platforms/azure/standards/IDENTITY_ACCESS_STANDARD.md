...
Use managed identities and federation, least-privilege RBAC, privileged access, conditional controls, and reviewable role scope.
...
**Requirement:** Use managed identities and federation, least-privilege RBAC, privileged access, conditional controls, and reviewable role scope.
