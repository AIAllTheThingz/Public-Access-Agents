---
id: AZ-STD-009
title: Azure Completion Evidence
version: 0.2.0
status: baseline
---
# Azure Completion Evidence

## Purpose

Record scope, identities, RBAC, network, data, policy, logs, resilience, cost, deployment, validation, and limitations.
...
**Requirement:** Record scope, identities, RBAC, network, data, policy, logs, resilience, cost, deployment, validation, and limitations.
