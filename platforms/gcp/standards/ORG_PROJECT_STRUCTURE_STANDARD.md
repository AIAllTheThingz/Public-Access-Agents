---
id: GCP-STD-001
title: Organization, Folder, and Project Standard
version: 0.2.0
status: baseline
---
# Organization, Folder, and Project Standard

## Purpose

Define resource hierarchy, project boundaries, environments, billing, ownership, labels, shared services, and policy inheritance.
...
**Requirement:** Define resource hierarchy, project boundaries, environments, billing, ownership, labels, shared services, and policy inheritance.
