---
id: GCP-EX-001
title: Google Cloud Platform Adoption Example
version: 0.2.0
status: baseline
---
# Google Cloud Platform Adoption Example

## Fictitious project

This example models a non-production project using the [Google Cloud Platform package](../README.md).
...
This example demonstrates composition only. It does not configure, test, approve, certify, or deploy Google Cloud Platform resources.
