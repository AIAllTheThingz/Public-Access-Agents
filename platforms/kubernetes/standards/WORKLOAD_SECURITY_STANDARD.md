---
id: K8S-STD-002
title: Workload Security Standard
version: 0.2.0
status: baseline
---
...
Apply pod security controls, non-root execution, capabilities, seccomp, filesystem, image, and admission requirements.
...
**Requirement:** Apply pod security controls, non-root execution, capabilities, seccomp, filesystem, image, and admission requirements.
