---
id: K8S-STD-001
title: Cluster and Namespace Standard
version: 0.2.0
status: baseline
---
# Cluster and Namespace Standard

## Purpose

Define cluster assumptions, tenancy, namespaces, labels, ownership, quotas, and boundaries between platform and application teams.
...
**Requirement:** Define cluster assumptions, tenancy, namespaces, labels, ownership, quotas, and boundaries between platform and application teams.
