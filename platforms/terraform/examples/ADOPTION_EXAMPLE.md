...
> Use the Terraform and OpenTofu Platform package as a platform overlay. Preserve governance, profile, language, discipline, framework, and other platform requirements. Confirm the target and actor before modification. Review destructive, public, privileged, data, recovery, and cost impact. Verify actual state and record exact evidence.
