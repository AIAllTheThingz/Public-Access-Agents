---
id: IAC-STD-009
title: Infrastructure-as-Code Completion Evidence
version: 0.2.0
status: baseline
---
# Infrastructure-as-Code Completion Evidence

## Purpose

Record engine, providers, modules, backend, variables, reviewed plan, apply result, drift, destructive impact, tests, and limitations.
...
**Requirement:** Record engine, providers, modules, backend, variables, reviewed plan, apply result, drift, destructive impact, tests, and limitations.
