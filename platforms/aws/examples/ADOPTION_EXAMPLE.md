---
id: AWS-EX-001
title: Amazon Web Services Platform Adoption Example
version: 0.2.0
status: baseline
---
# Amazon Web Services Platform Adoption Example

## Fictitious project

This example models a non-production project using the [Amazon Web Services Platform package](../README.md).
...
- [Amazon Web Services Platform](../README.md)
...
> Use the Amazon Web Services Platform package as a platform overlay. Preserve governance, profile, language, discipline, framework, platform, virtualization, operating-system, and networking requirements. Confirm the target and actor before modification. Review destructive, public, privileged, data, recovery, and cost impact. Verify actual state and record exact evidence.
...
This example demonstrates composition only. It does not configure, test, approve, certify, or deploy Amazon Web Services resources.
