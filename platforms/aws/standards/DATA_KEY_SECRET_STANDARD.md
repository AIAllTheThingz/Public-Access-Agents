...
Classify data, define encryption, KMS keys, secrets, certificates, rotation, backup, recovery, and access.
...
**Requirement:** Classify data, define encryption, KMS keys, secrets, certificates, rotation, backup, recovery, and access.
