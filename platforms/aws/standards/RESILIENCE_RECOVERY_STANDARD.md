---
id: AWS-STD-007
title: Resilience and Recovery Standard
version: 0.2.0
status: baseline
---
# Resilience and Recovery Standard

## Purpose

Define regions, availability zones, backups, restore, failover, dependency failure, quotas, and tested recovery objectives.

## Applicability

This standard applies when Amazon Web Services work changes the boundary described by this document.
...
**Requirement:** Define regions, availability zones, backups, restore, failover, dependency failure, quotas, and tested recovery objectives.
