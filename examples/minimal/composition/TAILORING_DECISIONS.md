---
id: EX-MIN-TAILOR-001
title: Minimal CLI Composition Example Tailoring Decisions
version: 0.1.0
status: baseline
---
# Minimal CLI Composition Example Tailoring Decisions

## Purpose

This record shows how shared standards are tailored to the fictitious **Minimal CLI Composition Example** project.
