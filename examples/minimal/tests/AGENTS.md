---
id: EX-MIN-SCOPE-002
title: Minimal CLI Composition Example Test scope
version: 0.1.0
status: baseline
---
# Minimal CLI Composition Example Test scope

## Scope

These instructions apply to `tests/` in the fictitious **Minimal CLI Composition Example** example.
