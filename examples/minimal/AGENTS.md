---
id: EX-MIN-AGENT-001
title: Minimal CLI Composition Example Root Agent Instructions
version: 0.1.0
status: baseline
---
# Minimal CLI Composition Example Root Agent Instructions

## Purpose

These are the root agent instructions for the fictitious **Minimal CLI Composition Example** composition.
