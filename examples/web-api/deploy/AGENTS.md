---
id: EX-API-SCOPE-003
title: Web API Composition Example Deployment scope
version: 0.1.0
status: baseline
---
# Web API Composition Example Deployment scope

## Scope

These instructions apply to `deploy/` in the fictitious **Web API Composition Example** example.
