---
id: EX-WRK-SCOPE-004
title: Worker Service Composition Example Deployment scope
version: 0.1.0
status: baseline
---
# Worker Service Composition Example Deployment scope

## Scope

These instructions apply to `deploy/` in the fictitious **Worker Service Composition Example** example.
