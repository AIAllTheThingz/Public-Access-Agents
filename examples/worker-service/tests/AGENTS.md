---
id: EX-WRK-SCOPE-003
title: Worker Service Composition Example Test scope
version: 0.1.0
status: baseline
---
# Worker Service Composition Example Test scope

## Scope

These instructions apply to `tests/` in the fictitious **Worker Service Composition Example** example.
