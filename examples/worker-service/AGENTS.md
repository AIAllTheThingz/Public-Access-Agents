---
id: EX-WRK-AGENT-001
title: Worker Service Composition Example Root Agent Instructions
version: 0.1.0
status: baseline
---
# Worker Service Composition Example Root Agent Instructions

## Purpose

These are the root agent instructions for the fictitious **Worker Service Composition Example** composition.
...
- [WORKER_SERVICE](../../profiles/WORKER_SERVICE.md)
