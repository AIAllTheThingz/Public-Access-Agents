---
id: EX-FULL-AGENT-001
title: Full-Stack Web Application Composition Example Root Agent Instructions
version: 0.1.0
status: baseline
---
# Full-Stack Web Application Composition Example Root Agent Instructions

## Purpose

These are the root agent instructions for the fictitious **Full-Stack Web Application Composition Example** composition.
...
- [WEB_APPLICATION](../../profiles/WEB_APPLICATION.md)
