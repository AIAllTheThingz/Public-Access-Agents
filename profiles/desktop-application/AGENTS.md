---
id: PROFILE-DESKTOP-AGENT-001
title: Desktop Application Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Desktop Application Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Desktop Application profile.
