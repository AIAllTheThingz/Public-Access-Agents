---
id: PROFILE-AUTOMATION-AGENT-001
title: Internal Automation Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Internal Automation Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Internal Automation profile.
