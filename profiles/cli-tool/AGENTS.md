---
id: PROFILE-CLI-AGENT-001
title: Command-Line Tool Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Command-Line Tool Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Command-Line Tool profile.
