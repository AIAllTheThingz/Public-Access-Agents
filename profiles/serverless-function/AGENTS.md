---
id: PROFILE-SERVERLESS-AGENT-001
title: Serverless Function Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Serverless Function Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Serverless Function profile.
