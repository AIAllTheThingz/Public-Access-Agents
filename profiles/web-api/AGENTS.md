---
id: PROFILE-WEB-API-AGENT-001
title: Web API Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Web API Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Web API profile.
