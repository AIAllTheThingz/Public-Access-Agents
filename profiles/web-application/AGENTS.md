---
id: PROFILE-WEB-APP-AGENT-001
title: Web Application Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# Web Application Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the Web Application profile.
