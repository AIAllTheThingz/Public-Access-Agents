---
id: PROFILE-AI-AGENT-AGENT-001
title: AI Agent Application Project Profile Agent Instructions
version: 0.2.0
status: baseline
---
# AI Agent Application Project Profile Agent Instructions

## Purpose

Defines mandatory behavior for agents working in a repository or scope governed by the AI Agent Application profile.
