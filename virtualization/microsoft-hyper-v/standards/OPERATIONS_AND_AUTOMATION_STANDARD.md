---
id: VIRT-HV-OPS-001
title: Microsoft Hyper-V Operations and Automation Standard
version: 0.1.0
status: baseline
---

# Microsoft Hyper-V Operations and Automation Standard

## Purpose

Define the detailed operating and automation contract for Microsoft Hyper-V work.

## Applicability

This standard applies to Windows Server Hyper-V hosts and clusters, Failover Clustering, Cluster Shared Volumes, VMs, checkpoints, virtual switches, live and storage migration, Hyper-V Replica, shielded VMs, WAC, SCVMM, and PowerShell.

## Authority and identity

- Connect only to Windows Server Failover Cluster, SCVMM fabric, or exact standalone Hyper-V host.
...
Verify current behavior with [Microsoft Hyper-V documentation](https://learn.microsoft.com/en-us/windows-server/virtualization/hyper-v/overview) and other official compatibility, security, lifecycle, and release documentation before execution.
