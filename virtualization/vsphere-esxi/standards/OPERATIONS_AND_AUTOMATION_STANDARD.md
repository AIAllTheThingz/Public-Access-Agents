...
# VMware vSphere and ESXi Operations and Automation Standard

## Purpose

Define the detailed operating and automation contract for VMware vSphere and ESXi work.
...
- Connect only to vCenter Server inventory when managed, or the exact standalone ESXi host when explicitly unmanaged.
