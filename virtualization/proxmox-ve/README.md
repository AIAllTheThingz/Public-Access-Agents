---
id: VIRT-PVE-README-001
title: Proxmox VE Package
version: 0.1.0
status: baseline
---
...
Provide project-agnostic standards for safe, testable, reviewable, recoverable, and evidence-based Proxmox VE engineering and automation.
...
The authoritative boundary is Proxmox VE cluster API and node membership, or the exact standalone PVE node.
...
Use Proxmox VE API, pvesh, supported CLI utilities, Ansible, Terraform providers, and Proxmox Backup Server interfaces.
