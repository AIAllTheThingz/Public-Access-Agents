---
id: FASTAPI-STD-004
title: Async and Concurrency Standard
version: 0.1.0
status: baseline
---
...
Keep blocking I/O out of async paths, define cancellation, timeouts, pools, background work, thread usage, and process-worker assumptions.
