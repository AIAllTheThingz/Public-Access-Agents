...
The framework package supplements the [Python language package](../../languages/python/) and applicable governance, discipline, platform, virtualization, operating-system, networking, profile, and project-specific standards.
