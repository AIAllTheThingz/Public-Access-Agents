...
Test user-visible behavior, accessibility, forms, routing, loading, errors, state transitions, and integration boundaries without coupling tests to implementation details.
