---
id: REACT-STD-002
title: State and Data Flow Standard
version: 0.1.0
status: baseline
---

# State and Data Flow Standard

## Purpose

Keep state minimal, colocated, and authoritative; avoid duplicated derived state and document cache, synchronization, and invalidation behavior.
