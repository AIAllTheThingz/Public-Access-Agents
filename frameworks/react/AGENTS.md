...
The framework package supplements the [JavaScript and TypeScript language package](../../languages/javascript-typescript/) and applicable governance, discipline, platform, profile, and project-specific standards.
