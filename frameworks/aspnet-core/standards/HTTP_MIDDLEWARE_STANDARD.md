---
id: ASPNET-STD-004
title: HTTP and Middleware Standard
version: 0.1.0
status: baseline
---

# HTTP and Middleware Standard

## Purpose

Keep middleware order deliberate, use consistent errors, bound request sizes and timeouts, preserve cancellation, and avoid leaking implementation details.
