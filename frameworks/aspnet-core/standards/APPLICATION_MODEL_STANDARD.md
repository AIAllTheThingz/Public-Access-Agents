---
id: ASPNET-STD-001
title: Application Model Standard
version: 0.1.0
status: baseline
---
...
Define the hosting model, request pipeline, endpoint style, background work, startup behavior, and shutdown expectations before implementation.
