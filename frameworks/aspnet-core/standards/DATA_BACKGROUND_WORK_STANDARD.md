---
id: ASPNET-STD-006
title: Data Access and Background Work Standard
version: 0.1.0
status: baseline
---

# Data Access and Background Work Standard

## Purpose

Scope data contexts correctly, use transactions intentionally, avoid blocking request threads, and make background work durable or explicitly best-effort.
