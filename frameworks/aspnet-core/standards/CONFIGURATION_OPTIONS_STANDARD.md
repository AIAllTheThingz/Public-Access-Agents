---
id: ASPNET-STD-002
title: Configuration and Options Standard
version: 0.1.0
status: baseline
---

# Configuration and Options Standard

## Purpose

Use strongly typed options, validate required values at startup, separate secrets from committed settings, and document precedence and reload behavior.
