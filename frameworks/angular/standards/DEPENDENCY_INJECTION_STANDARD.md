---
id: ANG-STD-002
title: Dependency Injection Standard
version: 0.1.0
status: baseline
---
...
Use providers and injection scopes deliberately, keep services cohesive, avoid hidden global state, and make initialization and teardown explicit.
