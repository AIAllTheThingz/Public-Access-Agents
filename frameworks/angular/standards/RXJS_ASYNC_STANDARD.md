---
id: ANG-STD-005
title: RxJS and Async Standard
version: 0.1.0
status: baseline
---

# RxJS and Async Standard

## Purpose

Define stream ownership, cancellation, teardown, sharing, errors, retries, and backpressure; prefer clear async behavior over operator puzzles.
