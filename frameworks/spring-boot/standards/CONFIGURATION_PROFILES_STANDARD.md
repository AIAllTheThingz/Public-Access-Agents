---
id: SPRING-STD-002
title: Configuration and Profiles Standard
version: 0.1.0
status: baseline
---

# Configuration and Profiles Standard

## Purpose

Use typed validated configuration, explicit profile behavior, approved secret stores, and documented precedence without embedding environment assumptions.
