---
id: SPRING-STD-006
title: Observability and Actuator Standard
version: 0.1.0
status: baseline
---

# Observability and Actuator Standard

## Purpose

Expose only required health and management endpoints, protect sensitive diagnostics, and define logs, metrics, traces, readiness, and ownership.
