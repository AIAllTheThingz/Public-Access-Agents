...
The framework package supplements the [Java language package](../../languages/java/) and applicable governance, discipline, platform, profile, and project-specific standards.
