...
This file defines mandatory rules for agents creating, modifying, reviewing, testing, securing, or documenting Spring Boot work.

The framework package supplements the [Java language package](../../languages/java/) and applicable governance, discipline, platform, virtualization, operating-system, networking, profile, and project-specific standards.
...
- `standards/CONFIGURATION_PROFILES_STANDARD.md`
- `standards/SECURITY_STANDARD.md`
- `standards/DATA_TRANSACTION_STANDARD.md`
- `standards/WEB_API_STANDARD.md`
- `standards/OBSERVABILITY_ACTUATOR_STANDARD.md`
